...
from jira_timesheet.services.ticket_report import (
    adf,
    build_html,
    build_report,
    lifecycle,
...
from jira_timesheet.services.ticket_report.render import e
from jira_timesheet.services.ticket_report.viewmodel import business_seconds, off_hours
...
class TestVerweisziele:
    ...
    def test_dubletten_und_leere_knoten_stoeren_nicht(self) -> None:
        assert adf.collect_urls(None) == []
        assert adf.collect_urls({"type": "doc", "content": []}) == []
