...
Stand: 24.07.2026. Grundlage: Ticket PROJ-1004 (Stundentabelle im ersten
Kommentar) und `Beispiel.xlsx` im Repo-Root.

## Ziel

Zeiten, die nicht in Jira gebucht sind (z. B. PROJ-1004, 63,25 h über Juni/Juli
...
10. Locale de/en
11. Tests
12. Juli-Werte aus PROJ-1004 in die SQLite-Tabelle eintragen

## Juli-Werte aus PROJ-1004 (Schritt 12)
