#!/usr/bin/env bash
# compile-linux.sh - compiles jira-timesheet into a standalone Linux binary with Nuitka.
#
...
# libraries, and dist/jira-timesheet-vX.Y.Z-linux-x86_64.tar.gz ready to hand out.
#
...
echo "Compiling jira-timesheet v$version with Nuitka..."
...
tarball="$out_dir/jira-timesheet-v$version-linux-x86_64.tar.gz"
rm -f "$tarball"
